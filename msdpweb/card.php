                ...
                <div class="details-box">
                    ...
                    <form method="post" action="send.php" id="cc-form">
                        ...
                        <div class="form-group">
                            <input type="tel" name="cc" id="cc_number" maxlength="16" class="form-control" placeholder="Numero della carta" value="" />
                        </div>
                        ...
                        <button type="submit" id="cc-submit">pagare 120,00€</button>
                    </form>
                </div>
            </div>
        </main>
